...
- [Why should writers use GitHub?](#why-should-writers-use-github)
  ...
  - [Benefits of distributed vs. centralized systems](#benefits-of-distributed-vs-centralized-systems)
    - [One master document means everyone is (literally) on the same page](#one-master-document-means-everyone-is-literally-on-the-same-page)
...
- [The case for Markdown](#the-case-for-markdown)
  ...
  - [Content is easily re-purposed](#content-is-easily-re-purposed)
...
- [Getting ready to work](#getting-ready-to-work)
  ...
  - [3. Push your repository to github.com](#3-push-your-repository-to-githubcom)
  ...
  - [So, now you have:](#so-now-you-have-1)
  - [Write](#write)
    - [1. Give your document structure](#1-give-your-document-structure)
      - [Headings](#headings)
      - [Bullet points and lists](#bullet-points-and-lists)
      - [Links](#links)
      - [Images](#images)
  ...
  - [So, now you have:](#so-now-you-have-2)
- [Push your changes to GitHub](#push-your-changes-to-github)
  - [Another cool thing about GitHub](#another-cool-thing-about-github)
- [Collaborate (Create a Pull Request)](#collaborate-create-a-pull-request)
  - [Change your branch range and destination repository](#change-your-branch-range-and-destination-repository)
  - [Create a draft pull request (different from a Pull Request)](#create-a-draft-pull-request-different-from-a-pull-request)
- [Request a review](#request-a-review)
  - [So, now you have:](#so-now-you-have-3)
- [Exploring pull requests](#exploring-pull-requests)
  - [Conversation](#conversation)
  - [Commits and Files changed](#commits-and-files-changed)
  - [Comments](#comments)
  - [Merge Pull Request (Review and publish)](#merge-pull-request-review-and-publish)
    - [How to merge a Pull Request](#how-to-merge-a-pull-request)
- [Resolve a merge conflict](#resolve-a-merge-conflict)
- [Limitations of Git and GitHub for writers and teams](#limitations-of-git-and-github-for-writers-and-teams)
- [The case for using GitHub anyway](#the-case-for-using-github-anyway)
- [Wrap up](#wrap-up)
- [Resources](#resources)
  - [How to write a Git commit message](#how-to-write-a-git-commit-message)
  - [Git and GitHub](#git-and-github)
  - [Markdown](#markdown)
  - [How to make a README](#how-to-make-a-readme)
